         ...
         <div className="max-w-[1440px] mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 md:gap-12 mb-16">
               ...
               <div className="text-center sm:text-left">
                  ...
                  <ul className="space-y-3 text-[13px] font-bold text-slate-500">
                     <li><Link to="/contact" className="hover:text-black hover:underline underline-offset-4">Contact Us</Link></li>
                     <li><Link to="/returns" className="hover:text-black hover:underline underline-offset-4">Returns & Exchange</Link></li>
                     <li><Link to="/shipping" className="hover:text-black hover:underline underline-offset-4">Shipping Policy</Link></li>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-16 text-center sm:text-left">
               <div>
                  ...
                  <p className="leading-loose">
                     {BRAND.name} Artisanal Studio <br />
               ...
               <div>
                  ...
                  <p className="leading-loose text-slate-500">
                     PH: <a href={WHATSAPP.chatUrl} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--primary)]">{WHATSAPP.displayNumber}</a> <br />
            ...
            <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center text-[10px] font-black uppercase tracking-widest text-slate-300 text-center md:text-left">
               <div className="space-y-4 flex flex-col items-center md:items-start">
                  <p>© {new Date().getFullYear()} {BRAND.fullName.toUpperCase()}. ALL RIGHTS RESERVED.</p>
               </div>
